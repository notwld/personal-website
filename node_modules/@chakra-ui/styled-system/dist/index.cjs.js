...
function createResolver(theme) {
  ...
  return function resolver(config, prop, value, props) {
    ...
    for (let i = 0; i < len; i++) {
      ...
      if (!isMultipart) {
        if (isSingle)
          (0, import_lodash3.default)(result, styles);
        else
          result[query] = styles;
        continue;
      }
...
function resolveStyleConfig(config) {
  return (props) => {
    ...
    return (0, import_lodash3.default)({}, runIfFn(config.baseStyle ?? {}, props), recipe(config, "sizes", size, props), recipe(config, "variants", variant, props));
  };
}
